...
public class SimpleSourceSinkDisplay extends JDialog {
	...
	private JTree sourcesinkTree;
	private JScrollPane scrollPane;
	private JButton buttonGoto;
	private final FlowGUIDelegate delegate;
	private final TreeSelectionModel selectionModel;

	public SimpleSourceSinkDisplay(FlowGUIDelegate delegate) {
		...
		buttonTrack.addActionListener(e -> onOK());
		...
		sourcesinkTree.setCellRenderer(new TaintTreeRenderer());

		// call onCancel() on ESCAPE
		contentPane.registerKeyboardAction(e -> onCancel(), KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE, 0),
				JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT);

		setTitle("Source Sink Inspection");
	...
	public void modelUpdate() {
		delegate.updateSourceSinkTreeModel(sourcesinkTree);
		sourcesinkTree.setSelectionModel(selectionModel);
		pack();
	}
	...
	public static void main(String[] args) {
		SimpleSourceSinkDisplay dialog = new SimpleSourceSinkDisplay(null);
		dialog.pack();
	...
	private void $$$setupUI$$$() {
		...
		sourcesinkTree = new JTree();
		scrollPane.setViewportView(sourcesinkTree);
	}
